        ...
        , div [ tableStyle ]
            [ model.schedule
                |> List.map
                    (\x ->
                        tr []
                            [ td [] [ x.year |> toString |> text ]
                            , td [] [ x.principalRemaining |> toString |> text ]
                            , td [] [ x.interest |> toString |> text ]
                            , td [] [ x.payment |> toString |> text ]

                            {--
                            , td [] [ x.principalRemaining |> round 2 |> text ]
                            , td [] [ x.interest |> round 2 |> text ]
                            , td [] [ x.payment |> round 2 |> text ]
                            --}
                            ]
                    )
                |> (++)
